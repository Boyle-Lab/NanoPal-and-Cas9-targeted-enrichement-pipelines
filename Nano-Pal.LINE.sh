...
#####
echo "Enter the your element (LINE): "  
read MEI 
MEI='LINE'
...
mv ${FC}.workspace.${MEI} ${FC}.workspace.old
rm -r ${FC}.workspace.old
mkdir ${FC}.workspace.${MEI}
cd ${FC}.workspace.${MEI}
...
#######MEI
blastn -evalue 0.001 -task blastn -gapopen 4 -query ${L1Hs} -subject blastn/${t}.fasta -outfmt "7 qacc sacc evalue qstart qend sstart send" > blastn/${t}.blastn.txt
...
#######MEI
cat blastn/${t}.blastn.txt | grep -v "#"  | awk 'BEGIN{flag=0}{if($5>5900&&($6<100||$7<100)&&($6<$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' >> 5.plus.txt 
cat blastn/${t}.blastn.txt | grep -v "#"  | awk 'BEGIN{flag=0}{if($5>5900&&($6<100||$7<100)&&($6>$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' >> 5.minus.txt 
cat blastn/${t}.blastn.txt | grep -v "#"  | awk 'BEGIN{flag=0}{if($5>5900&&($6>'$len_fix'||$7>'$len_fix')&&($6<$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' >> 3.plus.txt 
cat blastn/${t}.blastn.txt | grep -v "#"  | awk 'BEGIN{flag=0}{if($5>5900&&($6>'$len_fix'||$7>'$len_fix')&&($6>$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' >> 3.minus.txt
...
#######MEI
awk 'BEGIN{flag=0}{if($2~"'$a'"&&$5>5900&&($6<100||$7<100)&&($6<$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' blastn_refine.all.txt >> palmer.5.plus.txt
awk 'BEGIN{flag=0}{if($2~"'$a'"&&$5>5900&&($6<100||$7<100)&&($6>$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' blastn_refine.all.txt >> palmer.5.minus.txt
awk 'BEGIN{flag=0}{if($2~"'$a'"&&$5>5900&&($6>'$b_fix'||$7>'$b_fix')&&($6<$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' blastn_refine.all.txt >> palmer.3.plus.txt
awk 'BEGIN{flag=0}{if($2~"'$a'"&&$5>5900&&($6>'$b_fix'||$7>'$b_fix')&&($6>$7)) flag+=1} END{if(flag>=1) print "1";else print "0"}' blastn_refine.all.txt >> palmer.3.minus.txt
...
#######MEI
less ${S_refLINE} | grep L1PA > ref.L1PA
less ${S_refLINE} | grep L1HS > ref.L1HS
less ${S_refLINE} | grep -v L1HS | grep -v L1PA | grep L1 > ref.L1
...
less summary.final.2.txt |awk '{if($11!="NON") print $0}' |awk '{if(($3+$4+$5+$6+$7+$8+$9+$10)==0) print $0}'>  summary.final.no.L1.read.txt

less summary.final.2.txt |awk '{if($11!="NON") print $0}' |awk '{if(($3+$4+$5+$6)!=0) print $0}'>  summary.final.all.L1.read.txt
...
less summary.final.2.txt |awk '{if($11!="NON") print $0}' |awk '{if(($3+$4+$5+$6)!=0&&($7+$8+$9+$10)==0) print $0}'>  summary.final.ref.L1.read.txt
...
less summary.final.PALMER.L1.read.txt |awk '{if(($7+$8)>0&&($9+$10)==0&&$18==0&&($5+$6)>0) print $11,$13,$17,$18,"3"; else if(($7+$8)>0&&($9+$10)==0&&$18==1&&($3+$4)>0) print $11,$13,$17,$18,"3"; else if (($7+$8)==0&&($9+$10)>0&&$18==0&&($3+$4)>0) print $11,$12,$16,$18,"5"; else if (($7+$8)==0&&($9+$10)>0&&$18==1&&($5+$6)>0) print $11,$12,$16,$18,"5"}' | sort -k 2 -n | sort -k 1 > capture.loci.ref.add

less summary.final.ref.L1.read.txt |awk '{if(($3+$4)>0&&($5+$6)==0&&$18==0) print $11,$12,$16,$18,"5"; else if(($3+$4)>0&&($5+$6)==0&&$18==1) print $11,$13,$17,$18,"3"; else if (($3+$4)==0&&($5+$6)>0&&$18==0) print $11,$13,$17,$18,"3"; else if (($3+$4)==0&&($5+$6)>0&&$18==1) print $11,$12,$16,$18,"5"; else if(($3+$4)>0&&($5+$6)>0) print $11,$12,$16,$18,"5""\n"$11,$13,$17,$18,"3"}' | sort -k 2 -n | sort -k 1 > capture.loci.ref
...
less capture.loci.ref.all | grep L1HS  |  awk '{print $1,$2,$2+1,$3,$4,$5,"Nanopore"}'  > capture.loci.r.l1hs
less capture.loci.ref.all | grep -v L1HS | grep L1PA  |  awk '{print $1,$2,$2+1,$3,$4,$5,"Nanopore"}'  > capture.loci.r.l1pa
less capture.loci.ref.all | grep -v L1HS | grep -v L1PA | grep L1 |  awk '{print $1,$2,$2+1,$3,$4,$5,"Nanopore"}'  > capture.loci.r.l1other
less capture.loci.ref.all | grep -v L1HS | grep -v L1PA | grep -v L1 |  awk '{print $1,$2,$2+1,$3,$4,$5,"Nanopore"}'  > capture.loci.r.l1non
...
less inter.r.l1hs.txt | grep Nano | awk '{print $1,$2,$3}' | sort | uniq -c > r.l1hs.txt.fi
#less inter.r.l1hs.txt | grep Nano | awk '{print $1,$2,$3,$6,$14}' | sort | uniq -c > r.l1hs.txt.fi.2

less inter.r.l1pa.txt | grep Nano | awk '{print $1,$2,$3}' | sort | uniq -c > r.l1pa.txt.fi
#less inter.r.l1pa.txt | grep Nano | awk '{print $1,$2,$3,$6,$14}' | sort | uniq -c > r.l1pa.txt.fi.2


less inter.r.l1.txt | grep Nano | awk '{print $1,$2,$3}' | sort | uniq -c > r.l1.txt.fi
#less inter.r.l1.txt | grep Nano | awk '{print $1,$2,$3,$6,$14}' | sort | uniq -c > r.l1.txt.fi.2

#less ../capture.loci.potential.process |  awk '{print $1,$2}' | awk -F '' '{for(i=1;i<=(NF-3);i++){printf $i}; print "" }' | sort -n | uniq -c | grep -v chrUn | grep -v random > potential.polyL1.txt.fi
#wc -l potential.polyL1.txt.fi
